let statesData = require('./states.json');
//const data = JSON.parse(statesData);
//console.log(statesData.states[0].latitude);
for (let i = 0; i < statesData.states.length; i++){
    var name = statesData.states[i].state;
    var lat = statesData.states[i].latitude;
    var lng = statesData.states[i].longitude;
        ...
        function initMap(){
            ...
            async function getapi(url) {
                ...
                for(let i = 0; i < statesData.states.length; i++) {
                    ...
                    const name = statesData.states[i].state;
                    const lat = statesData.states[i].latitude;
                    const lng = statesData.states[i].longitude;
                    //console.log(name + lat + lng);
                    ...
                    const marker = new google.maps.Marker({
                        ...
                        map: map,
                        label: {color: '#000', fontSize: '15px', fontWeight: '600',text: "S"},
                    });
